    ...
    return (
        <div className="pt-20">
            <div className="header flex tablet:flex-row mobile:flex-col justify-between mb-5">
                <h1 className="text-3xl font-medium tablet:mb-0 mobile:mb-5">Trending</h1>
            ...
            <div onClick={handleClose} className="grid desktop:grid-cols-4 laptop:grid-cols-3 tablet:grid-cols-2 mobile:grid-cols-1 style-1">
                <div className="card tablet:w-11/12 mobile:w-full p-3 box-border bg-white rounded-lg mb-4">
                    <div className="header flex mb-1 relative">
                        ...
                        <div className="laptop:laptop:-right-14 py-3 mobile:right-0  hidden rounded-b-lg rounded-tr-lg top-6 absolute bg-white shadow-lg">
                            <ul>
