            ...
            <div className="pt-20">
                <div className="header flex justify-between mb-5">
                    ...
                    <div className="filter flex relative">
                        ...
                        <div className="box cursor-pointer w-10 h-10 ml-3 bg-white rounded-md flex justify-center items-center text-2xl text-darkGreen">
                            <RiLayoutMasonryLine />
                        </div>
                    </div>
                ...
                <div className="grid-cols-4 style-2 hidden">
