                    ...
                    <div className="row mb-5">
                        <div className="col-12">
                            <div className="form-group flex justify-around items-center">
                                <a href={`http://www.facebook.com/sharer.php?u=${props.link}`} target="_blank" className="circle text-white text-xl w-10 h-10 flex justify-center items-center bg-blue-400 rounded-full">
                                    <FiFacebook />
                                </a>
                                <a href={`https://twitter.com/share?url=${props.link}&text=Support%20Complaint%20Environment&hashtags=envcare`} target="_blank" className="circle text-white text-xl w-10 h-10 flex justify-center items-center bg-blue-300 rounded-full">
                                    <SiTwitter />
                                </a>
                                <a href={`mailto:?Subject=Support Complaint on EnvCare&Body=Support%20this%20complaint%20on%20EnvCare%20Thank%20You!%20 ${props.link}`} target="_blank" className="circle text-white text-xl w-10 h-10 flex justify-center items-center bg-red-500 rounded-full">
                                    <SiGmail />
                                </a>
                                <a href={`https://api.whatsapp.com/send?text=Support Complaint on ${props.link}`} data-action="shre/whatsapp/share" target="_blank" className="circle text-white text-xl w-10 h-10 flex justify-center items-center bg-green-400 rounded-full">
                                    <SiWhatsapp />
                                </a>
